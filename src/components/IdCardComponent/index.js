...
const IdCardModal = ({ isOpen, onClose, user, contentImage }) => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const linkYPosition = height - 190; // Adjust the Y position for the link
      ...
      pdf.textWithLink(
        ...
        linkYPosition,
        {
          url: "https://admissionform-six.vercel.app/payment",
        }
      );
    ...
    >
      <div style={{ position: "absolute", left: "-9999px", top: "-9999px" }}>
        <div ref={idCardRef} className="relative pt-1 w-[300px] h-[450px]">
          {/* Top Heading */}
          <h1 className="text-center text-xs font-serif font-semibold text-[#007076] mb-1">
            YOUR ID CARD
          </h1>
 ...
 */}
              ...
              <div className="absolute top-0 left-0 w-[37%] h-[35%] mt-[34.5%] ml-[53%] overflow-hidden">
                <p
                  className="id-card-text font-poppins font-semibold"
                  style={{
                    whiteSpace: "nowrap",
                    overflow: "hidden",
          ...
          <div className="mt-2 py-1 px-3 text-xs text-gray-600">
            <p className="text-center text-sm font-semibold font-serif text-[#007076] mb-1">
              PAYMENT METHOD
            </p>

            <p className="text-[9px] font-semibold text-[#007076] mb-1 inline-block border-b border-[#007076] leading-tight">
              Bank Details:
            </p>
            <p className="text-[7px] text-gray-700 mb-[-5px]">
              <span className="font-semibold text-[#007076]">Bank Name: </span>
              MCB Islamic
            </p>
            <p className="text-[7px] text-gray-700 mb-[-5px]">
              <span className="font-semibold text-[#007076]">
                Account Title:{" "}
              </span>
              Muhammad Rizwan
            </p>
            ...
            <p className="text-[9px] font-semibold text-[#007076] mt-2 mb-1 inline-block border-b border-[#007076] leading-tight">
              Only Via Easy Paisa:
            </p>
            <p className="text-[7px] text-gray-700 mb-[-5px]">
              <span className="font-semibold text-[#007076]">
            ...
            <p className="text-[6px] text-blue-600 underline leading-tight inline-block">
              {/* <a href="https://admissionform-six.vercel.app/payment">https://admissionform-six.vercel.app/payment</a> */}
            </p>

            <p className="text-[7px] text-gray-700 leading-tight mt-3">
              Payment submit kerny ke baad screenshot diye gaye link per upload
              karein aur 10-Jan se apni classes main shaamil ho jaein.
            </p>
            <p className="text-[7px] text-gray-700 leading-tight mt-">
              {" "}
              Mazeed details ke liye rabta karein 0343-4192648.
            </p>

            <p className="text-center text-sm font-semibold font-serif text-[#007076] mt-3">
              THANK YOU
            </p>
          </div>
        </div>
      ...
      <p
        className="mt-0 font-boldest text-1xl text-gray-700 ml-0 mr-0 lg:ml-[9%] md:ml-[9%] sm:ml-[9%] lg:mr-[9%] md:mr-[9%] sm:mr-[9%] lg:text-center md:text-center sm:text-center"
        style={{ fontWeight: "bold" }}
      >
        For your Registration Details, Download ID Card!
      </p>
