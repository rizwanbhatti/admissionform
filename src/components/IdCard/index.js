...
function IdCard({ user, contentImage }) {
  ...
  <div className="mx-auto w-[180px] h-[120px] relative">
            ...
            <div className="absolute w-[177px] h-[116px] z-10 overflow-hidden">
              ...
              {/* User Details */}
              <div className="absolute top-0 left-0 w-[37%] h-[35%] mt-[35%] sm:mt-[34.5%] ml-[53%] overflow-hidden">
              ...
              {/* User Roll Number */}
              <div className="absolute top-0 left-0 w-[20%] h-[10%] mt-[56.5%] sm:mt-[56%] ml-[18.5%] flex justify-center items-center">
                <p
                  style={{
                    color: "white",
                    fontSize: "7px",
  ...
  <div className="mt-2 py-1 px-3 text-xs text-gray-600">
    ...
    <p className="text-[7px] text-gray-700 leading-tight mt-3">
      Payment submit kerny ke baad screenshot diye gaye link per upload karein aur 20-Dec se apni classes main shaamil ho jaein.</p><p className="text-[7px] text-gray-700 leading-tight mt-"> Mazeed details ke liye rabta karein 0343-4192648.
    </p>
