        ...
        if (phone.length === 12) {
          ...
          if (formattedBatch && formattedBatch >= 1) {
            ...
            if (dateOfBirth) {
              ...
              const formattedFatherName = fatherName
                .trim()
                .replace(/\s+/g, " ");
    ...
    <>
      ...
      >
        <EditOutlined
          style={{
            cursor: "pointer",
            fontSize: isHoveOrange ? "20px" : "16px", // Set the desiOrange sizes
        ...
        extra={
          <Space>
            <Button
              onClick={onClose}
              style={{
                backgroundColor: "#f0f0f0", // Light Gray for cancel button
                color: "#595959", // Darker gray text color
            ...
            <Button
              ...
              style={{ backgroundColor: '#1890ff',  // Blue for submit button
                color: 'white',              // White text for contrast
                border: '1px solid #1890ff', // Matching border color
                 }}
            >
              SUBMIT
            </Button>
      ...
      >
        ...
        <div className="display-inline flex felx-col space-x-8 ml-[7%]">
          <div
            className="image-upload-container mb-12 mt-4 bg-[#e0e0e0] shadow-md shadow-gray-400"
            onClick={triggerFileInput}
          >
            {!studentImage ? (
              <label className="text-gray-600 text-2xl" htmlFor="file-upload">
                Upload <PlusOutlined />{" "}
              </label>
            ) : (
              <img
          ...
          >
            {!paymentImage || paymentImage == "Not-Done" ? (
              <label className="text-gray-600 text-2xl" htmlFor="file-upload">
                Upload Payment Image <PlusOutlined />{" "}
              </label>
            ) : (
              <img
                src={paymentImage}
        ...
        <div
          className="w-full mr-0 mb-0 ml-0 space-y-4 lg:space-y-1 md:space-y-1 mx:space-y-1
          ...
          <div style={{ marginTop: "20px" }}>
            <InputComponent
              ...
              onChange={(event) => {
                ...
                const formattedValue = newValue.replace(/\b\w/g, (char) =>
                  char.toUpperCase()
                );
